...
public class LocationService extends Service {
	...
	public void realStart(Intent intent) {
		if(readPreferences==false)
			getPreferenceValues();
		Notification notification = new Notification(R.drawable.icon, "Cebu Transport", System.currentTimeMillis());
		...
		notification.setLatestEventInfo(this, "Cebu Transport", "connected", pi);
